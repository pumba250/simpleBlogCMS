...
<script type="text/javascript">
  ...
  bkLib.onDomLoaded(function() {
        new nicEditors.allTextAreas({fullPanel : true});
        new nicEditor({iconsPath : '/images/nicEditorIcons.gif'});
  });
  </script>
        <div class="w3-container">
            <p><form method="POST" action="process_add_news.php">
        <input type="text" name="title" style="width:80%" placeholder="Заголовок" required><br>
        <textarea cols="60" style="width:80%; height:300px;" name="content" placeholder="Содержание" required></textarea><br>
