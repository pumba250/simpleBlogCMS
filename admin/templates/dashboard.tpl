...
<div class="w3-col l8 s12">
        ...
        <p>Количество сообщений обратной связи: <b><?= $totalFeedback ?></b></p>
<p>Количество коментариев: <b><?= $totalComm ?></b> из них на модерации: <b><?= $totalCommod ?></b></p>		<!-- Полное содержание -->
            <div class="w3-row">
