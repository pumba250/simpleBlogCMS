...
<footer class="w3-container w3-dark-grey w3-padding-32 w3-margin-top">
  <p align="center">Design by <a href="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a> &copy; {$currentYear} {$serverName}. Powered by <a href="https://release.yunisov.tech" target=_new>{$powered}_{$version}</a>. All rights reserved.</b><br>
  </p>
</footer>
</body></html>